            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_edit:
                        Toast.makeText(ToolBarActivity_01.this, "toolbar编辑被点击", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.action_share:
                        Toast.makeText(ToolBarActivity_01.this, "toolbar分享被点击", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.action_settings01:
                        Toast.makeText(ToolBarActivity_01.this, "toolbar设置01被点击", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.action_settings02:
                        Toast.makeText(ToolBarActivity_01.this, "toolbar设置02被点击", Toast.LENGTH_SHORT).show();
                        break;
