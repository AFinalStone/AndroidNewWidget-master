...
import com.example.floatingactionbutton.manager.AnimationManager;
...
public class FabMoveAnimate extends AnimationManager {


    public FabMoveAnimate(SuspensionFab fabView) {
        super(fabView);
    }
